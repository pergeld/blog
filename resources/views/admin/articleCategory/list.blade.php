                    ...
                    @forelse ($articleCategories as $articleCategory)
                        <tr>
                            ...
                            <td class="flex flex-col 2xl:flex-row justify-end items-end py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                @can('Hír kategória szerkesztés')
                                    <a href="/admin/articleCategories/{{ $articleCategory->id }}/edit" class="inline-flex items-center justify-center rounded-md bg-green-700 px-4 py-2 my-4 2xl:my-0 mx-0 2xl:mx-4 text-sm font-medium text-white shadow-sm hover:bg-green-900 focus:outline-none focus:ring-none sm:w-auto">
                                        Szerkesztés
                                    </a>
                                @endcan
                                @can('Hír kategória törlés')
