            ...
            <div class="mt-6 flex flex-col lg:flex-row">
                ...
                <div class="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-shrink-0 lg:flex-grow-0">
                    ...
                    <div class="mt-1 lg:hidden">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 rounded-md shadow-sm">
                                <a href="" class="group relative flex items-center justify-center rounded-md border border-gray-300 py-2 px-3 focus-within:ring-2 focus-within:ring-sky-500 focus-within:ring-offset-2 hover:bg-gray-50">
                    ...
                    <div class="relative hidden overflow-hidden rounded-full lg:block">
                        ...
                        <a href="" class="absolute rounded-full inset-0 flex h-full w-full items-center justify-center bg-black bg-opacity-75 text-sm font-medium text-white opacity-0 focus-within:opacity-100 hover:opacity-100">
                            <span>Csere</span>
                        </a>
                    </div>
                </div>
